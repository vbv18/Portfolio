...
export function Contact() {
  ...
  const onSubmit = async (values: ContactSchema) => {
    try {
      ...
      const message = err instanceof ContactApiError ? err.message : 'Something went wrong. Please try again.'
      toast.error(message)
    }
  }
          ...
          <Card>
            <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
              ...
              <div>
                ...
                <Textarea id="message" rows={5} placeholder="Tell me a bit more..." {...register('message')} />
